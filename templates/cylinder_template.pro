...
PostOperation {
  { Name MagSta_phi ; NameOfPostProcessing MagSta_phi;
    Operation {
      ...
      Print[ b, OnPlane{ {-DSV/2, -DSV/2, 0} {DSV/2, -DSV/2, 0} {-DSV/2, DSV/2, 0} } {200, 200},
        File "b_cut1.pos" ];
      Print[ b_abs, OnGrid {$B*Cos[$A], $B*Sin[$A], 0} { 0:2*Pi:2*Pi/1000, 0:DSV/2:DSV/2/100, 0 },
        File StrCat[outputFilename, "_cut1.pos"]];
      Print[ b_x, OnGrid {$B*Cos[$A], $B*Sin[$A], 0} { 0:2*Pi:2*Pi/1000, 0:DSV/2:DSV/2/100, 0 },
        File StrCat[outputFilename, "_b_x_cut1.pos"]];
